...
public class UIUserInfo extends UIForm {
    ...
    public UIUserInfo() throws Exception {
        ...
        addChild(UIKeyEntitiesForm.class, null, null);
    ...
    public void setUser(String userName) throws Exception {
        ...
        UIKeyEntitiesForm uiKeyEntitiesForm = getChild(UIKeyEntitiesForm.class);
        uiKeyEntitiesForm.load(username_);
        uiKeyEntitiesForm.getChild(UIListKeyEntities.class).load(username_);
