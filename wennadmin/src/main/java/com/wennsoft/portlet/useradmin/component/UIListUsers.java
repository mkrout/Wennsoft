...
public class UIListUsers extends UISearch {
    ...
    public static class ViewUserInfoActionListener extends EventListener<UIListUsers> {
        public void execute(Event<UIListUsers> event) throws Exception {
            ...
            UIUserMembershipSelector uiUserMembershipSelectorSet = uiUserManager.getChild(UIUserMembershipSelector.class);
            User user = service.getUserHandler().findUserByName(username);
            uiUserMembershipSelectorSet.setUser(user);
            uiUserMembershipSelectorSet.setRendered(true);
