...
@ComponentConfig(lifecycle = UIFormLifecycle.class, template = "app:/groovy/webui/component/keyEntitiesManagementPortlet/UIUserInfo.gtmpl", events = {
        ...
        @EventConfig(listeners = UIUserInfo.BackActionListener.class, phase = Phase.ANY),
        @EventConfig(listeners = UIUserInfo.AddKeyEntitiesActionListener.class, phase = Phase.DECODE)
})
@Serialized
public class UIUserInfo extends UIForm {
    ...
    public static class AddKeyEntitiesActionListener extends EventListener<UIUserInfo> 
    {
        public void execute(Event<UIUserInfo> event) throws Exception 
        {
        	UIUserInfo uiUserInfo = event.getSource();
            UIKeyEntitiesManagementPortlet uiKeyEntitiesManagementPortlet = uiUserInfo.getParent();
            uiKeyEntitiesManagementPortlet.setAddPopup(username_);
        }
    }
