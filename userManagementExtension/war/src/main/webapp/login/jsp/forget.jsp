  ...
  <body>
    ...
    <div class="uiLogin">
        ...
        <div class="centerLoginContent">
          <form name="loginForm" action="<%= contextPath + "/forget"%>" method="post" style="margin: 0px;">
                <% if (uri != null) { 
				...
				<input  id="emailAccount" name="emailAccount" type="text" placeholder="<%=res.getString("portal.login.Username")%>" onblur="this.placeholder = '<%=res.getString("portal.login.Username.blur")%>'" onfocus="this.placeholder = ''"/>
