...
<%
    ...
    boolean error = request.getAttribute("org.wennsoft.web.login.forget.error") != null;
...
<div class="uiLogin">
    <div class="loginContainer">
        <div class="loginHeader introBox">
            <div class="userLoginIcon"><%=res.getString("UserManagement.forget.Forgetlabel")%></div>
        </div>
        <div class="loginContent">
            <div class="titleLogin">
                ...
                <%
                    if(error) {
                %>
                <div class="signinFail"><i class="uiIconError"></i><%=res.getString("UserManagement.forget.SigninFail")%></div><%}%>
            </div>
            <div class="centerLoginContent">
                <form name="forgetForm" action="<%= contextPath + "/forget"%>" method="post" style="margin: 0px;">
                    <% if (uri != null) {
                    ...
                    <input  id="emailAccount" name="emailAccount" type="text" placeholder="<%=res.getString("UserManagement.forget.emailAccount")%>" onblur="this.placeholder = '<%=res.getString("UserManagement.forget.emailAccount")%>'" onfocus="this.placeholder = ''"/>


                    <div id="UIPortalLoginFormAction" class="loginButton" onclick="forget();">
                        <button class="button" href="#"><%=res.getString("UserManagement.forget.send")%></button>
                    </div>
